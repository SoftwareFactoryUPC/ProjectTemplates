...
<section id="content">
	...
	<div class="body_box">
		...
		<?php echo form_open_multipart(base_url()."panel/solucion/agregar", array("name"=>"form_registro", "id"=>"form_registro", "method"=>"post")); ?>
			<article class="inline una_col">
      
				<div class="block">
					<label>Titulo <span>(*)</span></label>
					<input type="text" name="no_solucion"  class="required" value="<?php echo set_value('no_solucion'); ?>" />				
                </div>
                <div class="block">
                    <label>Descripción Breve<a href="javascript:;">(250 caracteres máximo)</a><span>(*)</span></label>
                    <textarea name="tx_solucion_breve" class="required" style="height:70px;" ><?php echo set_value('tx_solucion_breve'); ?></textarea>	
                </div>
                <div class="block">
                    <label>Descripción<span>(*)</span></label>
                    <textarea name="tx_solucion" class="required editor" style="height:180px;" ><?php echo set_value('tx_solucion'); ?></textarea>	
                </div>
